...
def AnswerA(update: Update, context: CallbackContext) -> int:
    ...
    text= "cau trả lơi A của ban là đúng câu hỏi tiếp theo là : \n"+question['question']
    index_choice = query.data
    if index_choice == index_corect_answer_previous:
        text = "Correct Answer!      Next question" + question['question']
    else:
        text = "Wrong anwser!     " + answer[index_corect_answer_previous] + " is correct!" + question['question']
    query.edit_message_text(
...
def AnswerB(update: Update, context: CallbackContext) -> int:
    ...
    text = "cau trả lơi B của ban là đúng câu hỏi tiếp theo là : \n" + question['question']
    index_choice = query.data
    if index_choice == index_corect_answer_previous:
        text = "Correct Answer!      Next question" + question['question']
    else:
...
def AnswerC(update: Update, context: CallbackContext) -> int:
    ...
    text = "cau trả lơi C của ban là đúng câu hỏi tiếp theo là : \n" + question['question']
    index_choice = query.data
    if index_choice == index_corect_answer_previous:
        text = "Correct Answer!      Next question" + question['question']
    else:
...
def AnswerD(update: Update, context: CallbackContext) -> int:
    ...
    reply_markup = InlineKeyboardMarkup(keyboard)
    text = "cau trả lơi D của ban là đúng câu hỏi tiếp theo là : \n" + question['question']
    index_choice= query.data
    if index_choice == index_corect_answer_previous:
        text= "Correct Answer!      Next question" + question['question']
    else:
